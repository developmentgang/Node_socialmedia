...
export default function SignUp() {
  const SignUpSchema = Yup.object().shape({
    email: Yup.string().matches(/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/).required('Required', 'email is required'),
    password: Yup.string().length(8).required('first enter'),
   confirmPassword: Yup.string().oneOf([Yup.ref('password'),null],'Password Match: No').required('confirm password required')
  });
          ...
          <div className="col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
            ...
            <div className="card card-body rounded-3 p-4 p-sm-5">
              <div className="text-center">
                ...
                <span className="d-block">Already have an account? <a href="sign-in.html">Sign in here</a></span>
              </div>
              { /* <!-- Form START --> */}
              <form className="mt-4" onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-3 position-relative">
                  ...
                  <div className="input-group input-group-lg">
                    <input {...formik.getFieldProps('password')} className="form-control fakepassword" id="psw-input" placeholder="Enter new password" />
                ...
                { /* <!-- Confirm password --> */}
                <div className="mb-3 input-group-lg">
                  <input className="form-control" {...formik.getFieldProps('confirmPassword')} placeholder="Confirm password" />
                </div>
                ...
                { /* <!-- Copyright --> */}
                <p className="mb-0 mt-3 text-center">©2022 <a target="_blank" href="https://www.webestica.com/">Webestica.</a> All rights reserved</p>
              </form>
              { /* <!-- Form END --> */}
            </div>
            { /* <!-- Sign up END --> */}
